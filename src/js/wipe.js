...
function getAllOffsetLeft(element){
	...
	while(element){
		//将对象的offsetLeft属性累加保存到allLeft中
		allLeft += element.offsetLeft; //33 133 133
		//找到对象的offsetParent,即其有定位属性的父元素,将其重新赋值给element，实现逐级向上查找功能，一直到body标签结束
